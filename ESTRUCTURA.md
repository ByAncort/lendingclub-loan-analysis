...
| **S5** (13-15 Jul) | Documentación final, pruebas, empaquetado (Docker), ensayo presentación | `README.md` actualizado, `Dockerfile` |
...
| Documentación, evidencias y reproducibilidad | 15% |
